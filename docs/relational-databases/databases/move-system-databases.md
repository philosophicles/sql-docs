...
4.  In the **Existing parameters** box, select the -d parameter to move the master data file. In the **Specify a startup parameter** box, change the parameter to the new path of the master database. Click **Update** to save the change.
  
5.  In the **Existing parameters** box, select the -l parameter to move the master log file. In the **Specify a startup parameter** box, change the parameter to the new path of the master database. Click **Update** to save the change.
...
6.  Click **OK** to save these changes and close the **SQL Server (**_instance_name_**) Properties** dialog box.
